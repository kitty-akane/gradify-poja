...
public class CourseOfferingController {
  ...
  public ResponseEntity<CourseOffering> createCourseOffering(
    ...
    var course = entityManager.getReference(JCourse.class, courseOffering.courseId());
    var group = entityManager.getReference(JGroup.class, courseOffering.groupId());
    ...
    var toSave =
        JCourseOffering.builder()
            ...
            .teachers(teachers)
            .build();
    var saved = courseOfferingRepository.save(toSave);
    return ResponseEntity.status(HttpStatus.CREATED).body(courseOfferingMapper.toModel(saved));
  }
}
